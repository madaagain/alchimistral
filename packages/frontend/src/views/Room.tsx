...
export default function Room({ onLab, wsMessages }: RoomProps) {
        ...
        <div key={i} style={{ marginBottom: 16 }}>
          ...
          >
            ...
            <div className="flex-1">
              <div
                className="font-mono uppercase"
                style={{ fontSize: 8, color: c, letterSpacing: 1, fontWeight: 600 }}
              >
    ...
    <div className="flex-1 flex overflow-hidden" style={{ fontFamily: T.sans }}>
      ...
      <div className="flex-1 flex flex-col" style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          {wsMessages.map((msg, i) => (
            ...
            >
              ...
              <div style={{ maxWidth: '78%' }}>
                ...
                <div
                  className="font-mono"
                  style={{ fontSize: 8.5, color: T.t3, marginTop: 3 }}
                >
        ...
        <div
          ...
          style={{ padding: '14px 24px', borderTop: `1px solid ${T.bdr}` }}
        >
          <div
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                height: 30,
                borderRadius: 6,
                background: input.trim() ? T.t : T.bg3,
                border: 'none',
          ...
          <div
            ...
            style={{ marginTop: 5, fontSize: 8.5, color: T.t3 }}
          >
      ...
      <div
        ...
        style={{ width: 300, borderLeft: `1px solid ${T.bdr}` }}
      >
        {/* Tabs */}
        ...
        <div className="flex-1 overflow-y-auto" style={{ padding: 14 }}>
            ...
            <>
              ...
              {ARCH_STACK.map(({ key, value }) => (
                <div
                  ...
                  style={{ marginBottom: 5, fontSize: 9.5 }}
                >
              ...
              <div className="flex flex-col gap-0.5">
                {AGENT_TREE.map((r, i) => (
                  <div
                    ...
                    style={{ paddingLeft: r.depth * 14, fontSize: 9.5 }}
                  >
          ...
          {rightTab === 'mem' && (
            <>
              <SectionHeader>Global Memory</SectionHeader>
              {MEMORY_ITEMS.map((m, i) => (
                <div
                  key={i}
                  className="flex gap-1.5 items-start font-mono"
                  style={{ marginBottom: 5, fontSize: 9.5 }}
                >
                  <Minus size={8} style={{ color: T.t3, marginTop: 3, flexShrink: 0 }} />
          ...
          {rightTab === 'ctr' && (
            <>
              ...
              <div
                className="font-mono"
                style={{ fontSize: 9, color: T.t3, marginBottom: 12, lineHeight: 1.6 }}
              >
              ...
              {CONTRACTS.map((c, i) => (
                <div key={i} style={{ marginBottom: 12 }}>
                  ...
                  >
                    ...
                    <div className="font-mono" style={{ fontSize: 8, color: T.t3, marginTop: 3 }}>
                      by: <span style={{ color: T.t2 }}>{c.author}</span> · readers:{' '}
                      <span style={{ color: T.t2 }}>{c.readers.join(', ')}</span>
                    </div>
                  </div>
                  {expandedContract === i && (
                    <pre
